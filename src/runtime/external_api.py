...
def get_runtime_capabilities() -> dict[str, Any]:
    return {
        ...
        "collision_runtime": {
            "implemented": True,
            "owner": "winding_pose_solver",
            "method": "link_tool_static_mesh_narrowphase",
            "supports": [
                "single_pose_q_deg",
                "path_q_path_deg",
                "stop_on_first_collision",
                "tool_attachment_collision",
                "static_object_broadphase",
                "clearance_mm_distance_threshold",
                "visual_mesh_triangle_broadphase_coverage_patch",
                "visual_mesh_triangle_narrowphase",
                "visual_mesh_bvh_narrowphase",
                "visual_mesh_bvh_first_hit_priority",
                "collision_asset_cache_preload",
                "collision_asset_cache_preload_only",
            ],
            "requires": [
                "configured_solver_session",
                "robot_link_visuals",
                "dedicated_link_collision_assets",
                "visual_link_meshes_for_narrowphase",
                "dedicated_tool_collision_assets_when_tools_are_present",
                "visual_tool_meshes_for_narrowphase",
                "dedicated_static_collision_assets_when_static_collision_enabled",
                "visual_static_meshes_for_narrowphase",
                "matching_kinematics_hash",
            ],
            "scope": "robot_link_tool_self_collision_and_static_visual_mesh_narrowphase",
        },
